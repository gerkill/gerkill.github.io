...
class BookSearch extends Component {
	...
	render() {
		...
		/* Compare bookshelf to search query results and set shelf property
			of book object if it exists in the search.
		*/
		...
		return (
			<div className="search-books">
				<div className="search-books-bar">
					<a href="/MyReads" className="close-search">Close</a>
					<div className="search-books-input-wrapper">
						<input type="text" placeholder="Search Books" value={this.query} onChange={(event) => this.updateQuery(event.target.value)} />
					</div>
				</div>
